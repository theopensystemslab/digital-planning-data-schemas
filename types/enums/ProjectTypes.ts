...
export const ProjectTypes = {
  ...
  'alter.highways': 'Changes to a public road, pavement or path (including drop kerb)',
  ...
  'alter.openings.add.windows.high': 'Add doorways or new windows - 1.7m or higher',
  'alter.openings.alter': 'Change the size of doorways or windows',
  'alter.openings.alter.convert.doorToWindow': "Convert a doorway into a window",
  'alter.openings.alter.convert.windowToDoor': "Convert a window into a doorway",
  ...
  'changeofUse.annexe': 'Convert part of the property into a  granny flat (residential annexe)',
  ...
  'changeOfUse.outbuilding': 'Convert an outbuilding (such as a shed, garage or barn)', // Change the use of an outbuilding (such as a shed, garage or barn)
  ...
  'extend.outbuildings': 'Add an outbuilding (such as a shed, garage or garden office)', // Outbuildings (shed, car shelter or garden office)
  ...
  'new.temporaryStructure': 'Erect a temporary structure for historic visitor attractions and listed buildings',
