...
/**
 * This example is for a lawful development certificate application for proposed works that has an appeal decision
 */
export const lawfulDevelopmentCertificateProposedPostSubmission: PostSubmissionApplication =
  {
    ...
    data: {
      ...
      appeal: {
        ...
        startedDate: formatDateToYYYYMMDD(realisticDates.appeal.startedAt),
        decisionDate: formatDateToYYYYMMDD(realisticDates.appeal.decidedAt),
        decision: 'allowed',
      },
      caseOfficer: {
        name: 'Casey Officer',
