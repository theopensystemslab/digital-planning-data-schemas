...
export const reportAPlanningBreach: Enforcement = {
  data: {
    complainant: {
      name: {
        first: 'Ebenezer',
    ...
    property: {
      address: {
        ...
        y: 168345.09,
        title:
          'CHARES DICKENS WRITING CHALET, EASTGATE HOUSE, HIGH STREET, ROCHESTER',
        ...
        postcode: 'ME1 1EW',
        singleLine:
          'CHARES DICKENS WRITING CHALET, EASTGATE HOUSE, HIGH STREET, ROCHESTER, MEDWAY, ME1 1EW',
      },
      ...
      boundary: {
        site: {
          ...
          geometry: {
            ...
            coordinates: [
              [
                [0.5061100423336052, 51.387245941504915],
                [0.5061945319175742, 51.38713965241118],
                [0.5062454938888572, 51.387138815488186],
                [0.5063232779502891, 51.38716141240323],
                [0.5063809454441092, 51.387173966240084],
                [0.5064935982227345, 51.38722836616],
                [0.5064211785793326, 51.387287787537105],
                [0.5063098669052146, 51.387310384378566],
                [0.5061100423336052, 51.387245941504915],
              ],
            ],
          },
  ...
  responses: [
    ...
    {
      question:
        "Has the property or site already been granted planning permission for the works you're reporting?",
      responses: [
        {
          value:
            "Yes, it's been granted planning permission but I still think it's a breach",
        },
      ],
      metadata: {},
    },
  ...
  metadata: {
    ...
    schema: `https://theopensystemslab.github.io/digital-planning-data-schemas/${version}/schemas/enforcement.json`,
  },
};
