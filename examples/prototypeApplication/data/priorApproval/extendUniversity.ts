...
export const priorApprovalExtendUniversityPrototype: PrototypeApplication = {
  applicationType: 'pa.part7.classM',
  data: {
    user: {
      role: 'applicant',
    },
  ...
  files: [
    ...
    },
    {
      ...
      type: ['sitePlan.proposed', 'elevations.existing', 'elevations.proposed'],
    },
  ],
  metadata: {
