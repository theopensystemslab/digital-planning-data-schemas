...
export const advertConsentPrototype: PrototypeApplication = {
  ...
  data: {
    ...
    property: {
      address: {
        ...
        usrn: '21604494',
        pao: '32',
        street: 'CHARLTON PLACE',
        town: 'LONDON',
        postcode: 'N1 8AJ',
        singleLine: '32, CHARLTON PLACE, LONDON, ISLINGTON, N1 8AJ',
      },
      ...
      boundary: {
        site: {
          ...
          geometry: {
            ...
            coordinates: [
              [
                [-0.103119532150956, 51.5345720056254],
                [-0.103084555513111, 51.5346355722643],
                [-0.103028424790429, 51.5346195952392],
                [-0.103059552750763, 51.534558608242],
                [-0.103119532150956, 51.5345720056254],
              ],
            ],
          },
          properties: {
            label: '1',
            'area.hectares': 0.003154,
            'area.squareMetres': 31.54,
  ...
  responses: [
    ...
    {
      question: 'What best describes the advertisements you are applying for?',
      responses: [
        {
          value: 'Adverts relating to a business and situated on its premises',
        },
      ],
      metadata: {
    ...
    {
      question: 'How were the neighbours and the local community consulted?',
      responses: [
        {
    ...
    {
      question: 'How many projecting or hanging signs are you applying for?',
      responses: [
        {
          value: '1',
        },
    ...
    {
      question: 'Does the proposal include any other advertisements?',
      responses: [
        {
          value: 'Yes',
        },
    ...
    {
      question: 'Please describe the other advertisements',
      responses: [
        {
          value: 'All for the same business',
        },
      ],
      metadata: {
        sectionName: 'Your application',
    ...
    {
      question:
        'Is any of the advertisements you are applying for already in place?',
      responses: [
        {
          value: 'No',
        },
    ...
    {
      question:
        'Is an existing advertisement to be removed and replaced by an advertisement in this proposal?',
      responses: [
        {
          value: 'No',
        },
    ...
    {
      question:
        'Will any of the proposed advertisements project over a footpath or other public highway?',
      responses: [
        {
          value: 'No',
        },
    ...
    {
      question:
        'From what date are you seeking consent to display the advertisements?',
      responses: [
        {
          value: '2025-03-20',
        },
    ...
    {
      question:
        'Until what date are you seeking consent to display the advertisements?',
      responses: [
        {
          value: '2025-08-20',
        },
    ...
    },
    {
      ...
      responses: [
        {
          value: 'Caroline Chisholm 7946 0000  caroline@chisholm.com',
        },
      ],
      metadata: {
        sectionName: 'About you',
    ...
    {
      question:
        'Do you own the land or buildings where the adverts are to be placed?',
      responses: [
        {
          value: 'Yes',
        },
  ...
  files: [
    {
      name: 'https://api.editor.planx.dev/file/private/5djluga5/Screenshot%202025-01-30%20at%2013.48.33.png',
      type: ['advertsDrawings', 'sitePlan.proposed'],
    },
  ],
  metadata: {
    id: '5276b1c3-89fb-4c7b-98eb-59493f76e046',
    organisation: 'BBD',
    submittedAt: '2025-03-06T11:29:56.751Z',
    source: 'PlanX',
    service: {
      flowId: '0cb70043-c498-4c34-bd42-de64b4c61107',
      url: 'https://editor.planx.dev/templates/apply-to-display-an-advert-template/published',
      files: {
        required: ['advertsDrawings', 'sitePlan.proposed'],
