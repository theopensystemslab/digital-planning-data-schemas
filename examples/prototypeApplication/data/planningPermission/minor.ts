...
export const planningPermissionMinorPrototype: PrototypeApplication = {
  applicationType: 'pp.full.minor',
  data: {
    user: {
      role: 'applicant',
    },
    ...
    property: {
      ...
      use: {
        description: 'Sui generis - large HMO',
        vacant: true,
        knownContamination: false,
    ...
    proposal: {
      ...
      publicServiceInfrastructure: false,
      access: {
        affected: {
          vehicle: false,
          pedestrian: true,
      ...
      BNG: {
        ...
        preDevelopmentValue: {
          ...
          metricToolPublicationDate: '2024-02-12',
        },
        degradation: {
          value: false,
        },
      ...
      flood: {
        atRisk: false,
        within20mOfWatercourse: false,
        increaseRiskElsewhere: false,
        surfaceWaterDisposal: 'sustainableDrainageSystem',
      },
      natureImpacts: {
        protectedSpeciesAffected: 'false',
        designatedSitesAffected: 'false',
        geologicalSitesAffected: 'false',
      },
      use: {
        vulnerableToContamination: false,
      },
      trees: {
        onSite: true,
        influenceDevelopment: false,
      },
      effluent: {
        disposal: false,
      },
      ...
      employment: {
        existingEmployees: {
          fullTime: {number: 12},
          partTime: {number: 3},
          fullTimeEquivalent: {number: 13.5},
        },
        proposedEmployees: {
          fullTime: {number: 0},
          partTime: {number: 0},
          fullTimeEquivalent: {number: 0},
        },
      },
      hoursOfOperation: 'not applicable',
      site: {
        hectares: 0.069395,
      },
      commercialProcesses: {
      ...
      hazardousSubstanceStorage: false,
      parking: {
        cars: {
          count: 2,
          difference: -2,
