...
export const hedgerowRemovalNoticePrototype: PrototypeApplication = {
  ...
  data: {
    ...
    property: {
      address: {
        ...
        y: 181797.98,
        title:
          'THE ROYAL LONDON HOSPITAL, PO BOX 59, 192-206, WHITECHAPEL ROAD, LONDON',
        ...
        postcode: 'E1 1BB',
        singleLine:
          'THE ROYAL LONDON HOSPITAL, PO BOX 59, 192-206, WHITECHAPEL ROAD, LONDON, TOWER HAMLETS, E1 1BB',
      },
  ...
  responses: [
    {
      question: 'Is the property in Barnet?',
      responses: [
        {
          value: 'Yes',
        },
    ...
    },
    {
      ...
      responses: [
        {
          value:
            'I am/we are the owner(s) of the freehold of the land concerned',
        },
      ],
      metadata: {
        sectionName: 'About you',
  ...
  metadata: {
    ...
    service: {
      ...
      url: 'https://editor.planx.dev/templates/submit-a-hedgerow-removal-notice-template/published',
      files: {
